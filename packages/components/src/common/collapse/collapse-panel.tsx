...
import { CollapseValue, TdCollapsePanelProps } from '@td/intel/components/collapse/type';
import { useTNodeJSX, useContent, usePrefixClass, useCollapseAnimation } from '@td/adapter-hooks';
