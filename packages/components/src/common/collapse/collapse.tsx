...
import { CollapseValue, TdCollapseProps, CollapsePanelValue } from '@td/intel/components/collapse/type';
import { useVModel, useTNodeJSX, usePrefixClass } from '@td/adapter-hooks';
