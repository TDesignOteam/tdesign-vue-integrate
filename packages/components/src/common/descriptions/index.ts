...
import type { TdDescriptionsProps, TdDescriptionItemProps } from '@td/adapter-intel/components/descriptions/type';

import './style';

export * from '@td/adapter-intel/components/descriptions/type';
