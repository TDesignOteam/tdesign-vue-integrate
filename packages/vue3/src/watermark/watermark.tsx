...
import generateBase64Url from 'common/_common/js/watermark/generateBase64Url';
import randomMovingStyle from 'common/_common/js/watermark/randomMovingStyle';
import injectStyle from 'common/_common/js/utils/injectStyle';
